...
import { provideAcctAccessTokensRepository, provideAcctAccountRecordsRepository, provideAcctAccountsRepository, provideAcctAutocompleteRepository, provideAcctBanksRepository, provideAcctCurrenciesRepository, provideAcctDepositsRepository, provideAcctIconsRepository, provideAcctItemsRepository, provideAcctMonitoredCurrenciesRepository, provideAcctPrivilegesRepository, provideAcctUsersRepository, provideAcctWorkspacesRepository } from './config/repositories-config';
