...
/**
 * Specification for the data provider instances repository
 */
export abstract class AcctDataProviderInstancesRepository {

    /**
     * Retrieves a set of all the data provider instances available in the system
     */
    public abstract findAllDataProviderInstances() : Observable<DataProviderInstance[]>
     ...
     */
    public abstract findDataProviderInstanceProperties(dataProviderInstanceUUID:string) : Observable<DataProviderInstanceProperties>
     ...
     */
    public abstract saveDataProviderInstance(
     ...
     */
    public abstract deleteDataProviderInstance(dataProviderInstanceUUID:string) : Observable<void>
     ...
     */
    public abstract fetchDataProviderInstanceDataSet(
        dataProviderInstanceUUID : string,
